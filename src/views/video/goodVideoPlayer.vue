...
export default {
    ...
    methods:{
        goodVideoPlayer(){
            const video=  this.goodVideo.filter((item)=>{
    ...
    computed:{
        ...mapState({
            goodVideo:state=>state.video.goodVideo
        })
    },
    created() {
        // console.log(this.$route);
    this.$store.dispatch("video/requestGoodVideo",{id:this.$route.params.id});
